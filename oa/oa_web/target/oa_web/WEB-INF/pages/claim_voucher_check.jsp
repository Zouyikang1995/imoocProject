        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        <for:forEach items="${items}" var="item">
                    ...
                    <div class="section row">
                        <for:forEach items="${records}" var="record">
                    ...
                    <form:form id="admin-form" name="addForm" action="/claim_voucher/check" modelAttribute="record">
                        ...
                        <div class="panel-body bg-light">
                            ...
                            <div class="panel-footer text-right">
                                <for:if test="${sessionScope.employee.post==Contant.POST_FM || sessionScope.employee.post==Contant.POST_GM}">
                                ...
                                <for:if test="${sessionScope.employee.post==Contant.POST_CASHIER}">
