        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown menu-merge">
                <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                    <img src="assets/img/avatars/${sessionScope.employee.sn-10000}.jpg" alt="avatar" class="mw30 br64">
                ...
                <div class="sidebar-widget author-widget">
                    <div class="media">
                        <a class="media-left" href="#">
                            <img src="assets/img/avatars/${sessionScope.employee.sn-10000}.jpg" class="img-responsive">
                        </a>
