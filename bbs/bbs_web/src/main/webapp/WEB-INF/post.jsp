...
<div class="col-md-9 threads-show main-col">
    ...
    <div class="thread panel panel-default">
        <div class="infos panel-heading">
            ...
            <div class="meta inline-block">
                ...
                <a href="my.html"> <!-- 此处显示发帖人用户名 -->${comments[0].username} </a>

                • 于 <abbr title="2016-06-10 02:28:36" class="timeago">${comments[0].createTime}</abbr>

                回复</c:if> <a href="my.html"> ${post.username} </a> 于 <abbr title="2017-02-08 21:47:25"
                                                          class="timeago"><spring:eval expression="post.createTime"/></abbr> •
    ...
    <div class="replies panel panel-default list-panel replies-index">
        <div class="panel-heading">
            <div class="total">回复总数: <b>${comments.size()}</b></div>
        </div>
                ...
                <li class="list-group-item media " id="reply11">
                    ...
                    <div class="infos">
                        <div class="media-heading meta">
                            <a href="" title="strdemo" class="remove-padding-left author"> ${comment.username}</a>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="reply-box form">
                ...
                <form method="POST" action="/addComment" accept-charset="UTF-8" id="thread_create_form" class="create_form">
